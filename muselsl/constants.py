...
# Muse S Athena (Gen 3) — multiplexed BLE protocol (BrainFlow PR #779).
MUSE_ATHENA_GATT_DATA_1 = '273e0013-4c4d-454d-96be-f03bac821358'
MUSE_ATHENA_GATT_DATA_2 = '273e0014-4c4d-454d-96be-f03bac821358'
MUSE_ATHENA_GATT_CONTROL = MUSE_GATT_ATTR_STREAM_TOGGLE

MUSE_ATHENA_PACKET_HEADER_SIZE = 14
MUSE_ATHENA_SUBPACKET_HEADER_SIZE = 5

MUSE_ATHENA_EEG_SCALE = 1450.0 / 16383.0
MUSE_ATHENA_ACCELEROMETER_SCALE = 0.0000610352
MUSE_ATHENA_GYRO_SCALE = -0.0074768
MUSE_ATHENA_OPTICS_SCALE = 1.0
MUSE_ATHENA_BATTERY_SCALE = 1.0 / 512.0  # percent; matches BrainFlow (1/256 over-read 2x)

MUSE_ATHENA_DEFAULT_PRESET = 'p1041'
MUSE_ATHENA_VALID_PRESETS = frozenset({
    'p20', 'p21', 'p50', 'p51', 'p60', 'p61',
    'p1034', 'p1035', 'p1041', 'p1042', 'p1043', 'p1044', 'p1045', 'p1046',
    'p4129',
})

# tag -> (sensor_type, n_channels, n_samples, rate_hz, data_len, variable_length)
MUSE_ATHENA_SENSOR_CONFIG = {
    0x11: ('eeg', 4, 4, 256.0, 28, False),
    0x12: ('eeg', 8, 2, 256.0, 28, False),
    0x34: ('optics', 4, 3, 64.0, 30, False),
    0x35: ('optics', 8, 2, 64.0, 40, False),
    0x36: ('optics', 16, 1, 64.0, 40, False),
    0x47: ('acc_gyro', 6, 3, 52.0, 36, False),
    0x53: ('unknown', 2, 6, 32.0, 24, False),
    0x88: ('battery', 1, 1, 0.2, 0, True),
    0x98: ('battery', 1, 1, 1.0, 20, False),
}

MUSE_ATHENA_NB_EEG_CHANNELS = 4
MUSE_ATHENA_SAMPLING_EEG_RATE = 256
LSL_ATHENA_EEG_CHUNK = 12

MUSE_ATHENA_NB_ACC_CHANNELS = 3
MUSE_ATHENA_SAMPLING_ACC_RATE = 52
LSL_ATHENA_ACC_CHUNK = 1

MUSE_ATHENA_NB_GYRO_CHANNELS = 3
MUSE_ATHENA_SAMPLING_GYRO_RATE = 52
LSL_ATHENA_GYRO_CHUNK = 1

MUSE_ATHENA_NB_OPTICS_CHANNELS = 16
MUSE_ATHENA_SAMPLING_OPTICS_RATE = 64
LSL_ATHENA_OPTICS_CHUNK = 3
