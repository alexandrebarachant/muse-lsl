...
setup(name='muse-lsl',
      ...
      scripts=['scripts/muse-lsl.py', 'scripts/muse-lsl-stream.py', 'scripts/muse-lsl-record.py', 'scripts/lsl-viewer.py', 'scripts/lsl-record.py'],
      packages=['muselsl','muse'],
      package_dir={'muselsl': 'src', 'muse': 'src/muse'},
